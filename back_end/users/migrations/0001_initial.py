    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, null=True, upload_to=users.functions.user_avatar_path, verbose_name='头像')),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.Group', verbose_name='groups')),
                ('history', models.ManyToManyField(related_name='历史记录', to='content.Answer')),
                ('mylist', models.ManyToManyField(related_name='收藏夹', to='content.Answer')),
