...
const menu = (
    <Menu>
        ...
        <Menu.Item>
            <a target="_blank" rel="noopener noreferrer" href="">登录/注册</a>
        </Menu.Item>
    </Menu>
);
...
class App extends Component{
    render() {
      return (
        <div className="App">
            <Layout>
                <Header style={{position: 'fixed', zIndex:1,width:'1519px', background:'lightgray'}}>
                    <Row type="flex" justify="start">
                        <Col span={3} offset={0}>
                            <div className="homelogo">
                                <a href="./test.html"><Icon type="home" style={{color:'black'}}/></a>
                                <a href="" style={{color:'black',fontSize:'38px'}}>HOME</a>
                            </div>
                        </Col>
                        <Col span={3} offset={2}>
                ...
                <Content>
                    ...
                    <div>
                        ...
                        <Button className="enterbtn1"><a href="">Enter Now</a></Button>
                    </div>
                    <div>
                        ...
                        <Button className="enterbtn2"><a href="">Enter Now</a></Button>
